...
def get_args_parser():
    ...
    parser.add_argument("--model_type", default='epig_eae', choices=["epig_eae", "base"], type=str,
                        help="which types of model you would use. model with multi-prompt(epig_eae) or single-prompt(base)")
    parser.add_argument("--model_name_or_path", default="./ckpts/bart-base", type=str,
                        help="pre-trained language model")
    parser.add_argument("--dataset_type", default="rams", choices=["oeecfc", "rams", "wikievent"], type=str,
